...
export const projects: Project[] = [
  {
    id: 1,
    title: "AI-Powered Skin Cancer Analyser",
    description: "Full-stack application made on flask backend used to determine any type of skin cancer and provide info on it.",
    tags: ["HTML5", "CSS", "JavaScript", "Flask", "OpenCV", "API Integration"],
    githubLink: "https://github.com/Anshyll07/AI-Skin-Analysis",
    demoLink: "https://skin-cancer-ai-t54p.onrender.com/"
  },
  {
    id: 2,
    title: "TaskFlow",
  ...
  {
    id: 4,
    title: "Ecommerce Website for Artisans",
